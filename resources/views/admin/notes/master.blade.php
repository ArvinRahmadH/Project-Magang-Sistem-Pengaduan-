...
<head>
  ...
  <title>Admin Dashboard - Management Pengaduan</title>
  <link rel="icon" type="image/png" href="{{ asset('images/Logo_Polres_Malang-favicon.png') }}">
  <link rel="shortcut icon" type="image/png" href="{{ asset('images/Logo_Polres_Malang.png') }}">
